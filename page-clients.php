...
<?php if(is_user_logged_in(  )){?>
 <a href="<?php echo wp_logout_url(); ?>" class="btn btn-outline-danger px-3 py-2" style="cursor:pointer">Logout</a>    
<?php } 
else{?>
 <a href="<?php echo wp_registration_url(); ?>" class="px-3 py-2 btn btn-success" style="cursor:pointer">Sign Up</a>                
            <a href="<?php echo wp_login_url(); ?>" class="mr-2 px-3 py-2 btn btn-outline-primary" style="cursor:pointer">Log In</a>    
<?php }
