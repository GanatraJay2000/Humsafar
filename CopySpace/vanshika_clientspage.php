    ...
    <body>
		...
		<div class="container">
		    <div class="login">
			    ...
			    <button class="firstbtn" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Log In / Sign Up</button>
...
<div id="id01" class="modal">
  ...
  <form id="form1" class="modal-content" action="/action_page.php">
    <div class="signup-container">
      <div class="head-s"><h1><b>SIGN UP</b></h1></div>
      <div id="login" class="p-text"><p>Already a member? <a href="#">Log In</a></p>
      </div>
	  <br>
      ...
      <div class="ggl"><a href="#"><img src="https://image.flaticon.com/icons/svg/2702/2702602.svg" alt="google" width="40" height="40"></a>
	  </div>
	  <div class="fb"><a href="#"><img src="https://image.flaticon.com/icons/svg/1384/1384053.svg" alt="facebook" width="40" height="40"></a>
	  </div>
	  <br>
	  <br>
	  <br>
  ...
  <form id="form2" class="modal-content" action="/action_page.php">
    <div class="signup-container">
      <div class="head-s"><h1><b>LOG IN</b></h1></div>
      <div id="signup" class="p-text"><p>New to this site? <a href="#">Sign Up</a></p>
      </div>
	  <br>
	  <label for="email">Email</label>
      <input type="text" name="email" required>
  ...
  <form id="form3" class="modal-content" action="/action_page.php">
    <div class="signup-container">
      <div class="head-s"><h1>RESET PASSWORD</h1></div>
      <div class="p-text"><p>please enter your email address</p>
      </div>
	  <br>
	  <label for="email">Email</label>
      <input type="text" name="email" required>
	  ...
	  <br>
			...
			<div class="text"><p><a href="#">Deepak & Nikita are an adorable couple. They shied away from the usual spotlight (and sometimes the camera) that is always on the bride & ...</a></p>
			    <br><hr style="height:1px;border-width:0;background-color:#cccccc">
			</div>
			<div class="kebab">
  ...
  <div class="modal-content2">
	...
	<div id="content1">
	<h3>Share Post</h3>
	<a href="#"><img src="https://image.flaticon.com/icons/svg/179/179319.svg" width="40" height="40"/></a>
    <a href="#"><img src="https://image.flaticon.com/icons/svg/179/179342.svg" width="40" height="40"/></a>
    <a href="#"><img src="https://image.flaticon.com/icons/svg/179/179330.svg" width="40" height="40"/></a>
    <a id="link" href="#"><img src="https://image.flaticon.com/icons/svg/181/181531.svg" width="40" height="40"/></a>
    </div>
	<div id="content2">
	<h3>Share Link</h3>
	<div class="copy-link">
  ...
  <div class="modal-content2">
    ...
    <a href="#"><img src="https://image.flaticon.com/icons/svg/179/179342.svg" width="40" height="40"/></a>
    <a href="#"><img src="https://image.flaticon.com/icons/svg/179/179330.svg" width="40" height="40"/></a>
    <a id="link-2" href="#"><img src="https://image.flaticon.com/icons/svg/181/181531.svg" width="40" height="40"/></a>
    </div>
	<div id="content2-2">
	<h3>Share Link</h3>
	<div class="copy-link">
