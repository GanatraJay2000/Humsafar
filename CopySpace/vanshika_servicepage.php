...
<html lang="en">
    ...
    <body>
        ...
        <div class="flex-container">
			...
			<div>
			    <img id="my-img1" src="https://image.flaticon.com/icons/svg/2149/2149124.svg" alt="venue" onmouseover='hover1()' onmouseout='unhover1()'/>
	            <div><p><i>Venue</i></p></div>		
			</div>
			<div>
			    <img id="my-img2" src="https://image.flaticon.com/icons/svg/3132/3132686.svg" alt="decoration" onmouseover='hover2()' onmouseout='unhover2()'/>
			    <div><p><i>Decoration</i></p></div>
			</div>
			<div>
			    <img id="my-img3" src="https://image.flaticon.com/icons/svg/333/333367.svg" alt="catering" onmouseover='hover3()' onmouseout='unhover3()'/>
			    <div><p><i>Catering</i></p></div>
			</div>
			<div>
			    <img id="my-img4" src="https://image.flaticon.com/icons/svg/3129/3129839.svg" alt="entertainment" onmouseover='hover4()' onmouseout='unhover4()'/>
			    <div><p><i>Entertainments</i></p></div>
			</div>
			<div>
			    <img id="my-img5" src="https://image.flaticon.com/icons/svg/868/868039.svg" alt="photography" onmouseover='hover5()' onmouseout='unhover5()'/>
			    <div><p><i>Photography</i></p></div>
			</div>
			<div>
			    <img id="my-img6" src="https://image.flaticon.com/icons/svg/706/706481.svg" alt="bride"  onmouseover='hover6()' onmouseout='unhover6()'/>
			    <div><p><i>Dress Designing</i></p></div>
			</div>
			<div>
			    <img id="my-img7" src="https://image.flaticon.com/icons/svg/2448/2448162.svg" alt="mehendi" onmouseover='hover7()' onmouseout='unhover7()'/>
			    <div><p><i>Mehendi</i></p></div>
			</div>
			<div>
			    <img id="my-img8" src="https://image.flaticon.com/icons/svg/1987/1987581.svg" alt="makeup" onmouseover='hover8()' onmouseout='unhover8()'/>
			    <div><p><i>Make Up Artist</i></p></div>
			</div>
			<div>
			    <img id="my-img9" src="https://image.flaticon.com/icons/svg/2269/2269086.svg" alt="fire-work" onmouseover='hover9()' onmouseout='unhover9()'/>
			    <div><p><i>Fire Works</i></p></div>
			</div>
			<div>
			    <img id="my-img10" src="https://image.flaticon.com/icons/svg/2548/2548328.svg" alt="car" onmouseover='hover10()' onmouseout='unhover10()'/>
			    <div><p><i>Transport</i></p></div>
			</div>
			<div>
			    <img id="my-img11" src="https://image.flaticon.com/icons/svg/3132/3132676.svg" alt="drum" onmouseover='hover11()' onmouseout='unhover11()'/>
			    <div><p><i>Band / Dhol</i></p></div>
			</div>
			<div>
			    <img id="my-img12" src="https://image.flaticon.com/icons/svg/827/827249.svg" alt="horse" onmouseover='hover12()' onmouseout='unhover12()'/>
			    <div><p><i>Horse / Elephant</i></p></div>
			</div>
			<div>
			    <img id="my-img13" src="https://image.flaticon.com/icons/svg/1034/1034068.svg" alt="priest"  onmouseover='hover13()' onmouseout='unhover13()'/>
			    <div><p><i>Priest</i></p></div>
			</div>
			<div>
			    <img id="my-img14" src="https://image.flaticon.com/icons/svg/868/868079.svg" alt="invitation" onmouseover='hover14()' onmouseout='unhover14()'/>
			    <div><p><i>Stationary</i></p></div>
			</div>
			<div>
			    <img id="my-img15" src="https://image.flaticon.com/icons/svg/1139/1139931.svg" alt="gift" onmouseover='hover15()' onmouseout='unhover15()'/>
			    <div><p><i>Gift Packing</i></p></div>
			</div>
			<div>
			    <img id="my-img16" src="https://image.flaticon.com/icons/svg/3094/3094107.svg" alt="spotlight"  onmouseover='hover16()' onmouseout='unhover16()'/>
			    <div><p><i>Light & Sound</i></p></div>
			</div>
			<div>
			    <img id="my-img17" src="https://image.flaticon.com/icons/svg/375/375177.svg" alt="care"  onmouseover='hover17()' onmouseout='unhover17()'/>
			    <div><p><i>Hospitality</i></p></div>
			</div>
			<div>
			    <img id="my-img18" src="https://image.flaticon.com/icons/svg/859/859259.svg" alt="vermala" onmouseover='hover18()' onmouseout='unhover18()'/>
			    <div><p><i>Varmala Concept</i></p></div>
			</div>
			<div>
			    <img id="my-img19" src="https://image.flaticon.com/icons/svg/805/805952.svg" alt="bmw" onmouseover='hover19()' onmouseout='unhover19()'/>
			    <div><p><i>Luxury Cars</i></p></div>
			</div>
			<div>
