...
<body>
  ...
  <div class="content wrapper">
    ...
    <h1 id="ent_featured_artists" class="mt-4">
      <center>Featured Artists</center>
    </h1>
    <hr>
    </hr></br>
    <center>
            ...
            <?php foreach ($thumbnail_image as $image) { ?>
              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 thumbee ">
                ...
                <a class="thumbnail" href="<?php the_permalink(); ?>">
                  <img class="img-thumbnailee" id="ddee" src="<?php echo $image['url'] ?>" alt="Another alt text">
                </a>
              </div>
            <?php } ?>
      ...
      <div class="container" width="100%">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h1 class="">
              <center>Get To Know About Us</center>
            </h1>
            <hr></br>
